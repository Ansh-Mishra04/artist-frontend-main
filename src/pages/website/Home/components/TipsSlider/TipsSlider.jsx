    ...
    <div className="bg-black relative">
      ...
      <div className="mx-auto">
        <div className="container  px-4 lg:px-16 xl:px-16 text-white py-10 w-full">
          ...
          If you're also facing challenges, working hard, and striving for success in music, join this community platform today.
          </p>
        </div>
            ...
            {tips.map((tip) => (
              <div key={tip.id} className="px-2">
                <div
                  ...
                  onMouseUp={() => !isDragging && openModal(tip.video_file_url)}
                >
                  <Image
                    src={tip.thumbnails[0]}
