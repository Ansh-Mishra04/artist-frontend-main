...
const ArtistSlider = ({ rows = 1 }) => {
  ...
  const handleArtistClick = (id, index) => {
    ...
    if (artistProfileRef.current) {
      artistProfileRef.current.scrollIntoView({ behavior: "smooth", block: "center" });
    }
  };
      ...
      <div className="relative container mx-auto">
        ...
        <div className="flex justify-between">
          <div className="mb-16 relative p-4 lg:px-6">
            ...
            Artists Trusting Us
              <div className="text-[#5DC9DE] drop-shadow-[0_0_15px_rgba(34,211,238,1)] mt-2" >to Support Their Music Career</div>
            ...
            Explore the journeys of artists who are making their mark with us. Their success stories are just the beginning.
            </p>
          </div>
                ...
                >
                  <div className="flex justify-center overflow-hidden">
                    <Image
                      ...
                      fallback={<Shimmer width={200} height={200} className="rounded-full" />}
                      alt={artist.stage_name}
                      NativeImgProps={{
                        className: ` w-[200px] md:w rounded-full h-[200px] md:h-full object-cover ${
                          artist.id === currArtist ? "border-4 border-primary" : ""
                        }`,
                      }}
                    />
                  </div>
                  <div className="flex flex-col text-center items-center justify-end p-4">
                    ...
                    <p className={`text-sm ${artist.id === currArtist ? "text-white" : "text-gray-400"}`}>
