        ...
        <div className="relative w-full bg-cover bg-center">
          <div className="bg-black container xl:px-16 lg:px-10 px-6 mx-auto text-white pt-10">
            ...
            <div className="flex flex-col sm:flex-row gap-8 mb-12">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-400 mb-1">
                  Profession: <span className="text-white">{artist.profession}</span>
                </p>
                <p className="text-gray-400 mb-4">
                  Location: <span className="text-white">{artist.location}</span>
                </p>

                <div className="flex items-center gap-2 mb-4">
                  <span style={{ color: '#6F4FA0' }}>{artist.total_content} songs</span>
                  <span className="text-gray-600">→</span>
                  <span style={{ color: '#6F4FA0' }}> {artist.total_views} Listeners</span>
                </div>
                ...
                {artist &&
                  artist.songs.map((song, index) => (
                    <tr key={index} className="border-b border-gray-800 hover:bg-gray-800/50">
                      ...
                      <td className="py-4">
                        <div className="ms-5">
                          <div className="font-medium hidden sm:block truncate overflow-hidden whitespace-nowrap w-[150px]">
                            {truncateText(song.name, 20)}
                          </div>
                          {song.featuring_artists &&
                            song.featuring_artists.map((artist, ind) => (
                              <span key={ind} className="text-gray-400 me-2 text-sm">
                                {artist}
            ...
            <p
              ...
              className="underline hover:cursor-pointer text-lg text-[#5DC9DE]"
            >
              See More...
            </p>
          </div>
