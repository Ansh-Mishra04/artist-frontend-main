...
const IndividualEvent = () => {
        ...
        <div className="relative px-4 md:px-10 xl:px-16  text-white h-auto min-h-screen overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto my-10 pt-[250px] sm:pt-[400px]">
            ...
            <div className="flex sm:flex-row flex-col gap-4 mb-6">
              ...
              <div className="bg-white/5 backdrop-blur-none border
 p-4 rounded-lg text-center">
              ...
              <div className="sm:ml-auto backdrop-blur-sm border px-3 sm:px-6 rounded-lg bg-transparent w-[100%] lg:w-auto  p-6 transition-colors bg-gradient-to-b from-white/20 to-white/5 border-t border-l border-r border-white/20 border-b-transparent shadow-lg">
                <span className="text-xl lg:text-sm text-gray-300">CHANCE TO WIN</span>
                <span className="text-2xl ms-4 font-bold text-emerald-400">₹{singleEvent.reward_amount ? singleEvent.reward_amount : '0'}</span>
              </div>
            </div>
            ...
            <div className="space-y-4 mb-8">
              <div className="text-amber-400">
                Registration Date:{" "}
                <span className="text-white">{dateFormat(singleEvent.regn_start)} - {dateFormat(singleEvent.regn_end)}</span>
              </div>
              <div className="text-gray-300">
                Participated Users: <span className="text-white">{singleEvent.total_bookings}</span>
              </div>
              <div className="text-emerald-400">
                {dateFormat(singleEvent.event_date_time)} - {singleEvent.location}
              </div>
            </div>
            ...
            <div className="flex items-center gap-8">
              <div>
                ...
                <div className="text-3xl font-bold text-[#5DC9DE]">₹{singleEvent.fees}</div>
              </div>
              <button
                onClick={() => setIsModalOpen(true)}
                className={`bg-[#5DC9DE] text-black text-sm lg:text-2xl px-6 py-3 rounded-full font-medium font-semibold drop-shadow-[0_0_20px_white] ${
                  isEventInFuture ? 'hover:font-bold transition delay-300' : 'opacity-50 cursor-not-allowed'
                }`}
